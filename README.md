...
## Learning Objectives
- Understand how to replicate a Loading Bar application which is a simple loading bar web page that dynamically updates from 0% to 100% using JavaScript. It aids excellent user experience, and has beautiful user interface.

## Description of the Project
For the first milestone in the process of creating Loading bar, you will:
